...
import 'package:calendario_familiar/features/auth/presentation/login_screen.dart' as OriginalAuth;
...
final GoRouter _router = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      path: '/original-login',
      builder: (context, state) => const OriginalAuth.LoginScreen(),
    ),
  ],
);
      ...
      body: SingleChildScrollView(
        ...
        child: Center(
          child: ConstrainedBox(
            ...
            const SizedBox(height: 20),
            ElevatedButton(
              onPressed: () => context.go('/original-login'),
              child: const Text('Login Original (app)'),
            ),
