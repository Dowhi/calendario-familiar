...
// Eliminado: import family model (ya no se utiliza)
import 'dart:math';
...
class FirestoreService extends ChangeNotifier {
  ...
  // ===== FAMILIAS ===== 
  // Eliminado: funciones de familia ya no se utilizan

  /* COMENTADO - funciones de familia eliminadas
  ...
  FIN COMENTADO - funciones de familia eliminadas */
  ...
  Future<void> addShiftTemplate({
    ...
    bool calculateDuration = false,
    int? calculatedHours,
    int? calculatedMinutes,
    bool alarm1Enabled = false,
    bool previousDayAlarm = false,
    String? alarmTime,
  }) async {
    try {
