...
class EventRepository {
  ...
  Future<AppEvent> createEvent(AppEvent event, String currentUserId) async {
    try {
      ...
      final newEvent = event.copyWith(
        id: eventId,
        userId: currentUserId, // 🔹 Asignar el userId del usuario actual
        createdAt: now,
        updatedAt: now,
      );
      ...
      await NotificationService.scheduleEventNotification(newEvent, currentUserId: currentUserId);
  ...
  Future<AppEvent> updateEvent(AppEvent event) async {
    try {
      ...
      await NotificationService.scheduleEventNotification(updatedEvent, currentUserId: currentUserId);
